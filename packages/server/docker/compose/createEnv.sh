...
rm -f $FILE
echo POSTGRES_USER=$SECRET_POSTGRES_USER
echo POSTGRES_PASSWORD=$SECRET_POSTGRES_PASSWORD
echo POSTGRES_DATABASE=$SECRET_POSTGRES_DB
echo S3_BUCKET=$SECRET_DATABASE_BACKUP_S3_BUCKET
echo S3_ACCESS_KEY_ID=$SECRET_DATABASE_BACKUP_S3_ACCESS_KEY_ID
echo S3_SECRET_ACCESS_KEY=$SECRET_DATABASE_BACKUP_S3_SECRET_ACCESS_KEY
echo PASSPHRASE=$SECRET_DATABASE_BACKUP_PASSPHRASE
