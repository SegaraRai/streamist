/*
  ...
  - You are about to drop the column `parts` on the `SourceFile` table. All the data in the column will be lost.
...
INSERT INTO "new_SourceFile" ("createdAt", "fileSize", "filename", "id", "region", "sha256", "sourceId", "updatedAt", "uploaded", "userId") SELECT "createdAt", "fileSize", "filename", "id", "region", "sha256", "sourceId", "updatedAt", "uploaded", "userId" FROM "SourceFile";
